    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-8 md:p-24 bg-gradient-to-b from-white to-blue-50">
      <div className="text-center max-w-4xl">
        ...
        <p className="text-gray-500 mb-12 max-w-2xl mx-auto">
          Transform your notes into interactive quizzes. Master any subject with the power of AI.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <p className="text-sm text-gray-600">Organize your knowledge by categories</p>
          </div>
          ...
          <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <p className="text-sm text-gray-600">Get personalized questions instantly</p>
          </div>
          ...
          <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <p className="text-sm text-gray-600">Active recall for better retention</p>
          </div>
        </div>
      </div>
    </main>
